...
WebDriver driver = null;
	...
	public void handleMouseHoverOnClick(){
		...
		WebElement clothLink = driver.findElement(By.xpath("//*[@id='header-navigation']/div[1]/ul/li[7]/a"));
		
		Actions action = new Actions(driver);
		action.moveToElement(clothLink).build().perform();
		
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@id='CLOTHFOOTW_1']/ul/li[2]/ul/li[2]/a/span"))));
		
		WebElement trouserLink = driver.findElement(By.xpath("//*[@id='CLOTHFOOTW_1']/ul/li[2]/ul/li[2]/a/span"));
		trouserLink.click();
